...
def main():
    ...
    f1 = build_test_frame(seq_id=301, quorum_count=2, signer_bitmap=0x03)
    ...
    f2 = build_test_frame(seq_id=302, quorum_count=3, signer_bitmap=0x01)
    ...
    f3 = build_test_frame(seq_id=303, quorum_count=3, signer_bitmap=0x07, corrupt_keys=True)
    ...
    f4 = build_test_frame(seq_id=304, quorum_count=3, signer_bitmap=0x07, corrupt_sig=True)
    ...
    f5 = build_test_frame(seq_id=305, quorum_count=3, signer_bitmap=0x07)
    ...
    f6 = build_test_frame(seq_id=306, quorum_count=4, signer_bitmap=0x0F)
